...
namespace WebSite.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IGameResolver>().To<GameResolver>();
            kernel.Bind<IRockPaperScissorsGameService>().To<RockPaperScissorsGameService>();
            kernel.Bind<IComputerMoveGenerator>().To<ComputerMoveGenerator>();
        }        
    }
}
